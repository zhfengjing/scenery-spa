export const CONTRACTS = {
  YD_TOKEN: process.env.YD_TOKEN_ADDRESS || '',
  COURSE_MANAGER: process.env.COURSE_MANAGER_ADDRESS || '',
  AAVE_INTEGRATION: process.env.AAVE_INTEGRATION_ADDRESS || '',
};
      ...
      "outputs": [
        {
          ...
          "internalType": "struct CourseManager.Purchase[]",
          "name": "",
          "type": "tuple[]"
        }
      ],
